...
import { $ as useChartZAxis, Bt as isOrdinalScale, D as constant_default, Dt as useChartInteraction, En as useId, G as useYAxes, J as useDrawingArea, M as useChartGradientIdBuilder, O as useAnimate, Q as useChartHighlight, Sn as reactMajor_default, U as useXAxes, Ut as warnOnce, X as useChartsContext, Y as useStore, c as generateUtilityClasses, ct as useChartTooltip, fn as string_default, gt as useChartCartesianAxis, k as ANIMATION_TIMING_FUNCTION, l as generateUtilityClass, p as withPath, q as useChartId, s as useSkipAnimation, t as ChartsSurface, u as composeClasses } from "./ChartsSurface-C3IlIkBs.js";
import { G as Symbol, J as array_default, K as symbolsFill, Ot as useChartVisibilityManager, U as useFocusedItem, V as useSlotProps, X as useItemHighlightState, _t as getValueToPositionMapper, at as useAllSeriesOfType, b as ChartsLegend, c as getColor, g as ChartsOverlay, gt as useChartKeyboardNavigation, i as ChartsDataProvider, j as getSymbol, ot as useSeriesOfType, q as linear_default, r as useChartsContainerProps, s as getCurveFactory, t as ChartsWrapper, w as ChartsTooltip, yt as useChartBrush } from "./ChartsWrapper-FbMtSV45.js";
import { a as ChartsGrid, n as ChartsAxisHighlight, p as ChartsClipPath, s as ChartsAxis, t as useInternalIsZoomInteracting, v as selectorChartsHighlightXAxisIndex } from "./useInternalIsZoomInteracting-DdWGcZfE.js";
import { n as useInteractionItemProps, r as useItemHighlightStateGetter } from "./useInteractionItemProps-hGiM4qMn.js";
...
//#endregion
//#region node_modules/@mui/x-charts/internals/cleanId.mjs
/**
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/AppearingMask.mjs
...
function AppearingMask(props) {
	...
	const clipId = cleanId(`${useChartId()}-${props.seriesId}`);
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/AnimatedArea.mjs
init_extends();
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/lineClasses.mjs
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/AreaElement.mjs
init_extends();
init_objectWithoutPropertiesLoose();
var _excluded$10 = [
	"seriesId",
...
function AreaElement(props) {
	const { seriesId, classes: innerClasses, color, gradientId, slots, slotProps, onClick } = props, other = _objectWithoutPropertiesLoose(props, _excluded$10);
	const enablePositionBasedPointerInteraction = useStore().use(selectorChartExperimentalFeaturesState)?.enablePositionBasedPointerInteraction;
	const identifier = import_react.useMemo(() => ({
		type: "line",
		seriesId
	}), [seriesId]);
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/useAreaPlotData.mjs
	...
	return import_react.useMemo(() => {
		...
		for (const stackingGroup of stackingGroups) {
			...
			for (let i = groupIds.length - 1; i >= 0; i -= 1) {
				...
				if (xData === void 0) throw new Error(`MUI X Charts: ${xAxisId === "DEFAULT_X_AXIS_KEY" ? "The first `xAxis`" : `The x-axis with id "${xAxisId}"`} should have a data property to be able to display a line plot. The x-axis data defines the positions for each point in the line. Provide a data array to the x-axis configuration.`);
				if (xData.length < stackedData.length) throw new Error(`MUI X Charts: The data length of the x-axis (${xData.length} items) is less than the length of series data (${stackedData.length} items). Some data points will not be displayed because they have no corresponding x-axis value. Ensure the x-axis data has at least as many items as the series data.`);
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/AreaPlot.mjs
init_extends();
init_objectWithoutPropertiesLoose();
init_clsx();
var _excluded$9 = [
...
function AreaPlot(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AreaPlotRoot, _extends({ className: clsx(useUtilityClasses().areaPlot, className) }, other, { children: completedData.map(({ d, seriesId, color, area, gradientId }) => !!area && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AreaElement, {
		seriesId,
		d,
		color,
		gradientId,
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/AnimatedLine.mjs
init_extends();
init_objectWithoutPropertiesLoose();
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/LineElement.mjs
init_extends();
init_objectWithoutPropertiesLoose();
var _excluded$7 = [
	"seriesId",
...
function LineElement(props) {
	const { seriesId, classes: innerClasses, color, gradientId, slots, slotProps, onClick, hidden } = props, other = _objectWithoutPropertiesLoose(props, _excluded$7);
	const enablePositionBasedPointerInteraction = useStore().use(selectorChartExperimentalFeaturesState)?.enablePositionBasedPointerInteraction;
	const identifier = import_react.useMemo(() => ({
		type: "line",
		seriesId
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/useLinePlotData.mjs
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/LinePlot.mjs
init_extends();
init_objectWithoutPropertiesLoose();
init_clsx();
var _excluded$6 = [
...
function LinePlot(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LinePlotRoot, _extends({ className: clsx(useUtilityClasses().linePlot, className) }, other, { children: completedData.map(({ d, seriesId, color, gradientId, hidden }) => {
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/CircleMarkElement.mjs
init_extends();
init_objectWithoutPropertiesLoose();
var _excluded$5 = [
	"x",
...
function CircleMarkElement(props) {
	const { x, y, seriesId, classes: innerClasses, color, dataIndex, onClick, skipAnimation, isFaded = false, isHighlighted = false, hidden } = props, other = _objectWithoutPropertiesLoose(props, _excluded$5);
	const enablePositionBasedPointerInteraction = useStore().use(selectorChartExperimentalFeaturesState)?.enablePositionBasedPointerInteraction;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Circle, _extends({}, other, enablePositionBasedPointerInteraction ? {} : interactionProps, {
		cx: x,
		cy: y,
		r: 5,
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/MarkElement.mjs
init_extends();
init_objectWithoutPropertiesLoose();
var _excluded$4 = [
	"x",
...
function MarkElement(props) {
	const { x, y, seriesId, classes: innerClasses, color, shape, dataIndex, onClick, skipAnimation, isFaded = false, isHighlighted = false, hidden, style } = props, other = _objectWithoutPropertiesLoose(props, _excluded$4);
	const enablePositionBasedPointerInteraction = useStore().use(selectorChartExperimentalFeaturesState)?.enablePositionBasedPointerInteraction;
	const interactionProps = useInteractionItemProps({
		type: "line",
		seriesId,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MarkElementPath, _extends({}, other, enablePositionBasedPointerInteraction ? {} : interactionProps, {
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/useMarkPlotData.mjs
function useMarkPlotData(xAxes, yAxes) {
	...
	return import_react.useMemo(() => {
		...
		for (const stackingGroup of stackingGroups) {
			const groupIds = stackingGroup.ids;
			for (const seriesId of groupIds) {
				const { xAxisId = defaultXAxisId, yAxisId = defaultYAxisId, visibleStackedData, data, showMark, shape = "circle", hidden } = series[seriesId];
				if (!showMark) continue;
				if (!(xAxisId in xAxes) || !(yAxisId in yAxes)) continue;
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/MarkPlot.mjs
init_extends();
init_objectWithoutPropertiesLoose();
init_clsx();
var _excluded$3 = [
...
function MarkPlot(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MarkPlotRoot, _extends({ className: clsx(useUtilityClasses().markPlot, className) }, other, { children: completedData.map(({ seriesId, clipId, shape, xAxisId, marks, hidden }) => {
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/LineHighlightElement.mjs
init_extends();
init_objectWithoutPropertiesLoose();
var _excluded$2 = [
	"x",
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/LineHighlightPlot.mjs
init_extends();
init_objectWithoutPropertiesLoose();
...
function LineHighlightPlot(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("g", _extends({}, other, { children: highlightedIndexes.flatMap(({ dataIndex: highlightedIndex, axisId: highlightedAxisId }) => stackingGroups.flatMap(({ ids: groupIds }) => {
		return groupIds.flatMap((seriesId) => {
			const { xAxisId = defaultXAxisId, yAxisId = defaultYAxisId, visibleStackedData, data, disableHighlight, shape = "circle", hidden } = series[seriesId];
			if (hidden || disableHighlight || data[highlightedIndex] == null) return null;
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/LineChart.plugins.mjs
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/useLineChartProps.mjs
init_extends();
init_objectWithoutPropertiesLoose();
var _excluded = [
	"xAxis",
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/FocusedLineMark.mjs
var RADIUS = 6;
function FocusedLineMark() {
	...
	if (!series || series.hidden) return null;
...
//#endregion
//#region node_modules/@mui/x-charts/LineChart/LineChart.mjs
init_extends();
/**
* Demos:
*
...
var LineChart = /* @__PURE__ */ import_react.forwardRef(function LineChart(inProps, ref) {
	...
	const { chartsWrapperProps, chartsContainerProps, gridProps, clipPathProps, clipPathGroupProps, areaPlotProps, linePlotProps, markPlotProps, overlayProps, chartsAxisProps, axisHighlightProps, lineHighlightPlotProps, legendProps, children } = useLineChartProps(props);
	const { chartsDataProviderProps, chartsSurfaceProps } = useChartsContainerProps(chartsContainerProps);
	const Tooltip = props.slots?.tooltip ?? ChartsTooltip;
	const Toolbar = props.slots?.toolbar;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartsDataProvider, _extends({}, chartsDataProviderProps, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
		ref,
		children: [
...
LineChart.propTypes = {
	...
	axesGap: import_prop_types.default.number,
	...
	experimentalFeatures: import_prop_types.default.shape({ enablePositionBasedPointerInteraction: import_prop_types.default.bool }),
	...
	hiddenItems: import_prop_types.default.arrayOf(import_prop_types.default.oneOfType([import_prop_types.default.shape({
		...
		dataIndex: import_prop_types.default.number,
		seriesId: import_prop_types.default.string.isRequired,
		type: import_prop_types.default.oneOf(["line"])
	})]).isRequired),
	...
	onTooltipAxisChange: import_prop_types.default.func,
	...
	tooltipAxis: import_prop_types.default.arrayOf(import_prop_types.default.shape({
		axisId: import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.string]).isRequired,
		dataIndex: import_prop_types.default.number.isRequired
	})),
	...
	xAxis: import_prop_types.default.arrayOf(import_prop_types.default.object),
	yAxis: import_prop_types.default.arrayOf(import_prop_types.default.object)
};
//#endregion
export { useLineSeries as _, LineHighlightElement as a, LinePlot as c, AreaPlot as d, AreaElement as f, useAnimateArea as g, useAnimateLine as h, LineHighlightPlot as i, LineElement as l, AnimatedArea as m, FocusedLineMark as n, MarkPlot as o, lineClasses as p, LINE_CHART_PLUGINS as r, MarkElement as s, LineChart as t, AnimatedLine as u, useLineSeriesContext as v };

//# sourceMappingURL=LineChart-CMMnYRda.js.map