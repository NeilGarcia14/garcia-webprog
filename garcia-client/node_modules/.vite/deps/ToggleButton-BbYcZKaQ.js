import { a as __toCommonJS, n as __commonJSMin, o as __toESM, t as require_react } from "./react-C07QEYpT.js";
import { At as generateUtilityClass, Ct as _objectWithoutPropertiesLoose, Dt as init_generateUtilityClasses, Ft as init_resolveProps, It as resolveProps, Jt as _extends, Nt as init_composeClasses, Ot as generateUtilityClasses, Pt as composeClasses, St as init_clsx, Ut as require_prop_types, Yt as init_extends, kt as init_generateUtilityClass, rt as init_styled_engine, st as styled_engine_exports, wt as init_objectWithoutPropertiesLoose, xt as clsx } from "./identifier-CRL2n26U.js";
import { P as useForkRef, Q as ownerDocument, W as useEnhancedEffect, a as useSlotProps, ct as refType, i as init_useSlotProps, lt as init_HTMLElementType, st as init_refType, t as init_esm, ut as HTMLElementType, vt as chainPropTypes } from "./esm-Bb2SqidU.js";
...
import { n as styled, t as init_styled } from "./styled-5V4pUSuS.js";
import { c as alpha } from "./esm-B6yf8aUA.js";
...
//#endregion
//#region node_modules/@mui/material/node_modules/@mui/system/useThemeWithoutDefault.js
...
var PopperTooltip = /* @__PURE__ */ import_react.forwardRef(function PopperTooltip(props, forwardedRef) {
	var _slots$root;
	const { anchorEl, children, direction, disablePortal, modifiers, open, placement: initialPlacement, popperOptions, popperRef: popperRefProp, slotProps = {}, slots = {}, TransitionProps } = props, other = _objectWithoutPropertiesLoose(props, _excluded$2);
...
var Popper$1 = /* @__PURE__ */ import_react.forwardRef(function Popper(props, forwardedRef) {
	const { anchorEl, children, container: containerProp, direction = "ltr", disablePortal = false, keepMounted = false, modifiers, open, placement = "bottom", popperOptions = defaultPopperOptions, popperRef, style, transition = false, slotProps = {}, slots = {} } = props, other = _objectWithoutPropertiesLoose(props, _excluded2$1);
...
var Popper = /* @__PURE__ */ import_react.forwardRef(function Popper(inProps, ref) {
	...
	const { anchorEl, component, components, componentsProps, container, disablePortal, keepMounted, modifiers, open, placement, popperOptions, popperRef, transition, slots, slotProps } = props, other = _objectWithoutPropertiesLoose(props, _excluded$1);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopperRoot, _extends({
		as: component,
...
init_DefaultPropsProvider();
init_styled();
var _excluded = ["value"], _excluded2 = [
	"children",
	"className",
	"color",
	"disabled",
	...
	return _extends({}, theme.typography.button, {
		...
		[`&.${toggleButtonClasses.selected}`]: {
			...
			"&:hover": {
				...
				"@media (hover: none)": { backgroundColor: theme.vars ? `rgba(${selectedColorChannel} / ${theme.vars.palette.action.selectedOpacity})` : alpha(selectedColor, theme.palette.action.selectedOpacity) }
			}
		}
...
var ToggleButton = /* @__PURE__ */ import_react.forwardRef(function ToggleButton(inProps, ref) {
	const _React$useContext = import_react.useContext(ToggleButtonGroupContext), { value: contextValue } = _React$useContext, contextProps = _objectWithoutPropertiesLoose(_React$useContext, _excluded);
...
//#endregion
export { toggleButtonClasses as a, require_react_is as c, getToggleButtonUtilityClass as i, ToggleButtonGroupButtonContext as n, Popper as o, ToggleButtonGroupContext as r, getPopperUtilityClass as s, ToggleButton as t };

//# sourceMappingURL=ToggleButton-BbYcZKaQ.js.map