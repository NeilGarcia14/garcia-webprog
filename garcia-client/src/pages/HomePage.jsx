    ...
    <div className="flex w-full flex-col gap-6 bg-gradient-to-b from-slate-900 via-zinc-900 to-slate-900">
      <section className="border-y border-white/10 px-4 py-12 sm:px-6 sm:py-16 lg:px-12 lg:py-24">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="mb-4 text-[16px] font-semibold uppercase tracking-[0.3em] text-lime-300">
              Hello, I’m
            </p>
            <h1 className="font-bold leading-[0.9] text-white">
              <span className="text-zinc-200 block text-6xl mb-4">
                Neil Chester Mari N. Garcia
              </span>
              <span className="text-lime-500 text-6xl sm:text-7xl lg:text-6.5xl block">
                Full-stack Developer.
              </span>
            </h1>
            <p className="mt-10 max-w-lg text-lg leading-8 text-zinc-300">
              I craft user-centered web experiences with React, Tailwind, and modern patterns. 
              Explore my project work, core skills, and the progressive journey toward scalable solutions.
            </p>
            <div className="mt-12">
              <Button
                to="/about"
          ...
          <div className="relative justify-self-center lg:justify-self-end">
            <div className="absolute inset-0 rounded-full bg-lime-500/5 blur-3xl"></div>
            <div className="relative rounded-full border border-white/10 bg-zinc-900/30 p-4 sm:p-8 shadow-2xl">
              <img
                src={logo}
                alt="My Photo"
                className="h-72 w-72 sm:h-96 sm:w-96 lg:h-[500px] lg:w-[500px] object-cover rounded-full transition duration-500"
              />
            </div>
          </div>
        </div>
      ...
      <section className="border-y border-white/10 px-4 py-6 sm:px-6 sm:py-8 lg:px-8 bg-gradient-to-r from-slate-900 via-zinc-900 to-slate-900">
        <div className="mb-6">
          <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-lime-300">
            Growth Metrics
          </p>
          <h2 className="mt-2 text-2xl font-semibold text-white">
            Impact-driven milestones
          </h2>
        </div>

        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-3xl border border-white/10 bg-zinc-900/40 p-5 hover:border-lime-500/50 transition">
            <p className="text-2xl font-bold text-lime-500">04</p>
            <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.24em] text-zinc-500">
              Projects
            </p>
          </div>
          <div className="rounded-3xl border border-white/10 bg-zinc-900/40 p-5 hover:border-lime-500/50 transition">
            <p className="text-2xl font-bold text-lime-500">02</p>
            <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.24em] text-zinc-500">
          ...
          <div className="rounded-3xl border border-white/10 bg-zinc-900/40 p-5 hover:border-lime-500/50 transition">
            <p className="text-2xl font-bold text-lime-500">01</p>
            <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.24em] text-zinc-500">
              Ongoing Project
            </p>
          </div>
